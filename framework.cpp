...
void office_wing()
{
    ...
    delay(10);
    print_endl("\nYou take note of the clue for this room.");
    delay(3);
...
void observatory()
{
    ...
    print_endl("\nThe safe opens and you find a piece of parchment with the letter “U” and a peculiar star-shaped key, with the inscription “dreams” on its side. \nThese seem to be the room’s clues.");
